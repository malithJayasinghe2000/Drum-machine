...
power ?
sounds.map(sound => /*#__PURE__*/React.createElement(KeyboardKey, { play: play, sound: sound })) :
sounds.map(sound => /*#__PURE__*/React.createElement(KeyboardKey, { play: play, sound: { ...sound, url: "#" } })));




const DumControle = ({ stop, power, name, volume, handleVolumeChange, changeSoundsGroup }) => /*#__PURE__*/
React.createElement("div", { className: "controle" }, /*#__PURE__*/
React.createElement("button", { onClick: stop }, "Turn the power ", power ? "OFF" : "ON"), /*#__PURE__*/
...
React.createElement("button", { onClick: changeSoundsGroup }, "change sounds Group"));
